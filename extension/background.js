...
function updateRedirectRules() {
    chrome.storage.sync.get("redirectDomain", (data) => {
        ...
        const urls = [
            ...
            { url: `${domain}/bss-b2b-nt-js.js`, urlFilter: `https://cdn.shopify.com/extensions/*/assets/bss-b2b-nt-js.js` },
            { url: `${domain}/bss-b2b-integrate.js`, urlFilter: `https://cdn.shopify.com/extensions/*/assets/bss-b2b-integrate.js` },
